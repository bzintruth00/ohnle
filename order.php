...
<ul class="orderlist">
 ...
 <form action="orderlist.php" method="post">
    ...
    <div class='user-order'>
        <input type='text' placeholder="&nbsp&nbsp&nbsp상세 주소를 적어주세요" autofocus="autofocus" required="required" name="name"><br>
        <input type='tel' placeholder="&nbsp&nbsp&nbsp연 락 처" autofocus="autofocus" required="required" name="phon"><br>
